...
function LoadConfig () {
  ...
  Scripts.Summoner = true;
    ...
    Config.Summoner.KillSpecters = true;
  Scripts.ClearAnyArea = true;
    Config.ClearAnyArea.AreaList = [74];
  Scripts.Tombs = false;
  ...
  */
  ...
  Config.AttackSkill[0] = 117; // Preattack skill. Not implemented yet.
  ...
  Config.LowManaSkill[1] = 120; // Low mana aura.
